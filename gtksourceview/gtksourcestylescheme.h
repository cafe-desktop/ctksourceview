...
G_GNUC_INTERNAL
GtkSourceStyleScheme	*_ctk_source_style_scheme_new_from_file			(const gchar          *filename);

G_GNUC_INTERNAL
GtkSourceStyleScheme	*_ctk_source_style_scheme_get_default			(void);

G_GNUC_INTERNAL
const gchar		*_ctk_source_style_scheme_get_parent_id			(GtkSourceStyleScheme *scheme);

G_GNUC_INTERNAL
void			 _ctk_source_style_scheme_set_parent			(GtkSourceStyleScheme *scheme,
										 GtkSourceStyleScheme *parent_scheme);

G_GNUC_INTERNAL
void			 _ctk_source_style_scheme_apply				(GtkSourceStyleScheme *scheme,
										 GtkSourceView        *view);

G_GNUC_INTERNAL
void			 _ctk_source_style_scheme_unapply			(GtkSourceStyleScheme *scheme,
										 GtkSourceView        *view);

G_GNUC_INTERNAL
GtkSourceStyle		*_ctk_source_style_scheme_get_matching_brackets_style	(GtkSourceStyleScheme *scheme);

G_GNUC_INTERNAL
GtkSourceStyle		*_ctk_source_style_scheme_get_right_margin_style	(GtkSourceStyleScheme *scheme);

G_GNUC_INTERNAL
GtkSourceStyle          *_ctk_source_style_scheme_get_draw_spaces_style		(GtkSourceStyleScheme *scheme);

G_GNUC_INTERNAL
gboolean		 _ctk_source_style_scheme_get_current_line_color	(GtkSourceStyleScheme *scheme,
										 GdkRGBA              *color);

G_GNUC_INTERNAL
gboolean		 _ctk_source_style_scheme_get_background_pattern_color	(GtkSourceStyleScheme *scheme,
										 GdkRGBA              *color);
